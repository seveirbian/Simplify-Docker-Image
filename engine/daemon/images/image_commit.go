...
// 修改： 添加simp参数
func (i *ImageService) CommitImage(c backend.CommitConfig, simp bool) (image.ID, error) {
	// 修改
	...
	// 修改： 添加对simp参数的判断，当simp参数为true时，不再设置父镜像
	if c.ParentImageID != "" || simp {
		// 修改
